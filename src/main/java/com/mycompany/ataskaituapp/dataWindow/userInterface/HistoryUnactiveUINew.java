...
public class HistoryUnactiveUINew{
    ...
    public HistoryUnactiveUINew(ArrayList<Report> list, boolean flagInsert, String text, String group) {
    ...
    public VBox getView() {
        ...
        if(flagInsert) {
            ...
            this.date.createHashMapUn(this.listYearMonth.get(this.listYearMonth.size()-1).getToYear(),
                    this.listYearMonth.get(this.listYearMonth.size()-1).getToMonth());
        }
        ...
        //Cia kazka reikia taisyti su nustatymais, nes redaguojant neveiklaus ataskaita,
        //met klaida su ComboBox
        ...
        if(this.flagInsert) {
            ...
            lastYear.getItems().addAll(date.lastYearListUn());
            lastYear.setValue(this.listYearMonth.get(this.listYearMonth.size()-1).getToYear());
            
            lastMonth.getItems().addAll(date.lastMonthListbyYearUn((Integer) lastYear.getSelectionModel().getSelectedItem()));
            lastMonth.setValue(this.listYearMonth.get(this.listYearMonth.size()-1).getToMonth());
        ...
        for(FromToService dates: this.listYearMonth) {
